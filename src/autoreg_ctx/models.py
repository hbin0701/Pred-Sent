        ...
        for _ in range(N):
            with torch.no_grad():
                ...
                def get_second_last_newline_hidden_states(
                    ...
                    encoder_hidden_states_full: torch.Tensor,
                    ...
                    # Build batch-wise gather indices
                    ...
                    # Gather second-to-last hidden states
                    second_last_hidden = encoder_hidden_states_full[batch_range, second_last_nl.clamp(min=0), :]
                    second_last_hidden[no_nl] = default_vecs[no_nl]

                    return second_last_hidden
                
                encoder_hidden_states_unprojected = get_second_last_newline_hidden_states(
