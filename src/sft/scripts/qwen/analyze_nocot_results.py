...
def extract_answer(text):
    # Extract the letter after "### " in the text
...
def analyze_results(results_dir):
        ...
        with open(file_path, 'r') as f:
            for line in f:
                try:
                    ...
                    # Extract prediction (should be in format ["### X"])
                    pred = extract_answer(data['preds'][0])
                    
                    # Extract true answer (last character of the answer string)
                    true_answer = data['answer'][-1]
                    
                    if pred and true_answer and pred == true_answer:
                        correct += 1
                    total += 1
    ...
    print("\n=== CSQA No-CoT Evaluation Results ===")
...
if __name__ == "__main__":
    results_dir = "/home/hyeonbin/Pred-Sent/results/qwen/csqa-nocot-new"
